...
private :
	...
	// для вычисления диапазона полосы прогресса при отправке письма
	uint speed;         // скорость интернета
	double k;             // поправочный коэффициент к speed
